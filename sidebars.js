...
const sideBarDoc = [
  ...
  {
    type: 'html',
    value: '<div class="sidebar_line"><div class="line"></div></div>'
  },
  {
    type: 'category',
    label: 'Design',
    ...
    items: [
      {
        type: 'doc',
        label: 'Page',
        id: 'components/box/page/use'
      },
      {
        type: 'doc',
        label: 'Page',
        id: 'components/box/page/style'
      },
      {
        type: 'doc',
        label: 'Page',
        id: 'components/box/page/props'
      },
      /*--*/
      {
        type: 'doc',
        label: 'Pop',
        id: 'components/box/pop/use'
      },
      {
        type: 'doc',
        label: 'Pop',
        id: 'components/box/pop/style'
      },
      {
        type: 'doc',
        label: 'Pop',
        id: 'components/box/pop/props'
      },
      /*--*/
      {
        type: 'doc',
        label: 'Module',
        id: 'components/box/module/use'
      },
      {
        type: 'doc',
        label: 'Module',
        id: 'components/box/module/style'
      },
      {
        type: 'doc',
        label: 'Module',
        id: 'components/box/module/props'
      },
      /*--*/
      {
        type: 'doc',
        label: 'Layout',
        id: 'components/box/layout/use'
      },
      {
        type: 'doc',
        label: 'Layout',
        id: 'components/box/layout/style'
      },
      {
        type: 'doc',
        label: 'Layout',
        id: 'components/box/layout/props'
      },
    ]
  },
  /*---*/
  {
    ...
    items: [
      ...
      {
        type: 'html',
        value: '<div class="sidebar_group">表单</div>'
      },
      {
        type: 'doc',
        label: 'From',
      ...
      {
        type: 'html',
        value: '<div class="sidebar_group">基础</div>'
      },
      {
        type: 'doc',
        label: 'Icon',
      ...
      {
        type: 'html',
        value: '<div class="sidebar_group">表格</div>'
      },
      {
        type: 'doc',
        label: 'Data',
      ...
      {
        type: 'html',
        value: '<div class="sidebar_group">反馈</div>'
      },
      {
        type: 'doc',
        label: 'Banner',
      ...
      {
        type: 'html',
        value: '<div class="sidebar_group">图表</div>'
      },
      {
        type: 'doc',
        label: 'Scene',
